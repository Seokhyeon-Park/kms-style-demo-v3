            ...
            <div className={style.mainContainer}>
                ...
                <div className={windowWidth > 1550?style.loginContainer:style.loginContainerOff}>
                    ...
                    <div className={style.linkContainer}>
                        <label className={style.linkLabel} onClick={toManagerLoginPage}>관리자 페이지로 이동</label>
                    </div>
                    <button type="submit" className={style.normalBtn} >로그인</button>
                </div>
            </div>
        </div>
    );
